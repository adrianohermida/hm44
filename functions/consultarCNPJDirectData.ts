...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const url = `https://apiv3.directd.com.br/api/CadastroPessoaJuridica?CNPJ=${cnpjLimpo}&TOKEN=${token}`;
    ...
    await base44.asServiceRole.entities.ConsumoAPIExterna.create({
      ...
      endpoint_id: '694999729d2ed8feb8ddbb9e',
      operacao: 'consulta_cnpj',
      parametros: { cnpj: cnpjLimpo.substring(0, 2) + '***' },
      sucesso,
