...
export default function PlanosSidebar({ honorarios, selected, onSelect, isOpen, onToggle, isAdmin }) {
  return (
    <>
      <Button
        variant="ghost"
      ...
      <aside
        ...
        `}
      >
        <HonorariosList honorarios={honorarios} selected={selected} onSelect={onSelect} isAdmin={isAdmin} />
      </aside>
