...
export default function PropriedadesEditaveis({ ticket }) {
  ...
  const { data: departamentos = [] } = useQuery({
    queryKey: ['departamentos-props', escritorio?.[0]?.id],
  ...
  return (
    <ScrollArea className="h-full">
      <div className="p-4 space-y-4">
        ...
        {/* Departamento */}
        <div>
          <Label className="text-xs text-gray-500 mb-1">Grupo</Label>
          <Select
